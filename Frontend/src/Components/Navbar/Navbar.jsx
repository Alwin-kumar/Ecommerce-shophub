...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-around p-[16px]  w-320 shadow-2xl sticky top-0 bg-[#E195AB] px-2 py-12 text-[18px] h-[85px] lg:px-2 lg:py-10 xl:w-381   lg:w-381 md:w-330 sm:w-330 xl:h-[90px] lg:h-[90px]  '>
